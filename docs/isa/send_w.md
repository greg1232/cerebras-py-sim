# SEND_W (Send West) — Internal Hardware Primitive
...
## Description
Sends the content of a register to the West neighbor core via the NESW mesh. This primitive is invoked automatically by the hardware when a global memory operation requires westward routing.
