# WAIT_E (Wait East) — Internal Hardware Primitive
...
## Description
Stalls the hardware global memory unit until a packet arrives from the East neighbor on the NESW mesh. Invoked automatically by the hardware to synchronize eastward global memory transactions.
